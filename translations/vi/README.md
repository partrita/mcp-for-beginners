...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:53:26+00:00",
...
**Model Context Protocol (MCP)** là một khung làm việc tiên tiến được thiết kế để chuẩn hóa các tương tác giữa các mô hình AI và ứng dụng khách. Giáo trình mã nguồn mở này cung cấp một lộ trình học tập có cấu trúc, đi kèm với các ví dụ mã thực hành và các trường hợp sử dụng thực tế, trên các ngôn ngữ lập trình phổ biến như C#, Java, JavaScript, TypeScript và Python.
...
| 3.10 | Sử dụng máy chủ nâng cao | Sử dụng máy chủ nâng cao để tận dụng các tính năng và cải thiện kiến trúc | [Hướng dẫn](./03-GettingStarted/10-advanced/README.md) |
...
| 04 | Triển khai thực tế | SDK, gỡ lỗi, kiểm thử, mẫu lệnh có thể tái sử dụng | [Xem thêm](./04-PracticalImplementation/README.md) |
...
| 11 | Tích hợp Cơ sở Dữ liệu Máy chủ MCP | Lộ trình học thực hành 13 bài toàn diện về tích hợp PostgreSQL | [Labs](./11-MCPServerHandsOnLabs/README.md) |
...
#### [Ngày 1: Năng suất MCP, Công cụ Phát triển & Cộng đồng:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
Hãy học về Model Context Protocol (MCP), một khung tiên tiến được thiết kế để chuẩn hóa các tương tác giữa các mô hình AI và ứng dụng khách. Qua phiên học thân thiện với người mới bắt đầu này, chúng tôi sẽ giới thiệu bạn về MCP và hướng dẫn bạn tạo máy chủ MCP đầu tiên của mình.  
...
- **Chương trình học Cốt lõi (00-11)**: Nội dung chính được tổ chức trong mười một module liên tiếp, bao gồm các bài thực hành tích hợp cơ sở dữ liệu toàn diện
- **11-MCPServerHandsOnLabs/**: Lộ trình học 13 bài hoàn chỉnh để xây dựng máy chủ MCP sẵn sàng sản xuất với tích hợp PostgreSQL
...
- [**MỚI** AI Edge cho Người mới bắt đầu](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)
...
- [AI Tạo sinh cho Người mới bắt đầu sử dụng JavaScript](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)
...
Dự án này có thể chứa các thương hiệu hoặc logo của các dự án, sản phẩm, hoặc dịch vụ. Việc sử dụng hợp pháp các thương hiệu hoặc logo của Microsoft phải tuân theo và phù hợp với  
