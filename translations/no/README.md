...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:48:54+00:00",
...
Enten du er AI-utvikler, systemarkitekt eller programvareingeniør, er denne guiden en omfattende ressurs for å mestre MCP-grunnleggende og implementeringsstrategier.
...
| 3.9 | Utrulling | Utrull MCP-servere til produksjon | [Guide](./03-GettingStarted/09-deployment/README.md) |
...
| 3.11 | Enkel autentisering | En kapittel som viser autentisering fra starten og RBAC | [Guide](./03-GettingStarted/11-simple-auth/README.md) |
...
| 11 | MCP Server Database-integrasjon | Omfattende 13-labs praktisk læringssti for PostgreSQL-integrasjon | [Labs](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.3 | Sikkerhet og Multi-Tenancy | Radnivåsikkerhet, autentisering og tilgang til data for flere leietakere | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | Miljøoppsett | Oppsett av utviklingsmiljø, Docker, Azure-ressurser | [Lab 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
| 11.5 | Databaseutforming | PostgreSQL-oppsett, detaljhandelsdatabaseskjema og eksempeldata | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.11 | Utrullingsstrategier | Docker-utrulling, Azure Container Apps og skaleringshensyn | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
- Bygging av MCP-servere og integrering av dem i agentopplevelser
...
- **Kjernepensum (00-11)**: Hovedinnholdet organisert i elleve sekvensielle moduler, inkludert omfattende databaseintegrasjons-labs
- **11-MCPServerHandsOnLabs/**: Komplett 13-labs læringssti for å bygge produksjonsklare MCP-servere med PostgreSQL-integrasjon
