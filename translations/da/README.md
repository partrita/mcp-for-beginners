...
| 3.11 | Enkel autentificering | Et kapitel, der viser dig autentificering fra begyndelsen og RBAC | [Vejledning](./03-GettingStarted/11-simple-auth/README.md) |
...
| 11.5 | Database Design | PostgreSQL-opsætning, design af detailskema og eksempeldata | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.8 | Semantisk Søgning | Implementering af vektorembeddings med Azure OpenAI og pgvector | [Lab 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.11 | Implementeringsstrategier | Docker-implementering, Azure Container Apps og skaleringsovervejelser | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
| 11.13 | Best Practices | Optimering af ydeevne, styrkelse af sikkerhed og produktionstips | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
- Registry alignment og værktøjer (1P + 3P)
...
Lær gennem intensive videosessioner, hvordan man opretter MCP-servere, integrerer med VS Code og implementerer professionelt på Azure baseret på indhold fra MCP for Beginners-pensum. Gå derfra med praktiske færdigheder i en teknologi, som store virksomheder allerede bruger.
...
Dette projekt kan indeholde varemærker eller logoer for projekter, produkter eller tjenester. Autoriseret brug af Microsofts varemærker eller logoer skal følge [Microsofts retningslinjer for varemærker og brand](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Brug af Microsofts varemærker eller logoer i modificerede versioner af dette projekt må ikke skabe forvirring eller antyde Microsoft-sponsorering. Enhver brug af tredjeparts varemærker eller logoer er underlagt disse tredjeparts politikker.
