...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:01:45+00:00",
...
|--------|-------|-------------|------|
| **Modul 1-3: Základy** | | | |
| 00 | Úvod do MCP | Prehľad Model Context Protocol a jeho významu v AI procesoch | [Čítajte viac](./00-Introduction/README.md) |
...
| 5.12 | Entra ID Auth | Autentifikácia s Microsoft Entra ID | [Sprievodca](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 5.14 | Context Engineering | Techniky efektívneho kontextového inžinierstva | [Sprievodca](./05-AdvancedTopics/mcp-contextengineering/README.md) |
...
| 11 | Integrácia databázy MCP Server | Komplexná 13-laboratórna praktická cesta učenia pre integráciu PostgreSQL | [Laboratóriá](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Základná architektúra | Porozumenie architektúre MCP servera, databázovým vrstvám a bezpečnostným vzorom | [Laboratórium 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | Bezpečnosť a multi-tenancy | Bezpečnosť na úrovni riadkov, autentifikácia a prístup k dátam pre viacerých nájomcov | [Laboratórium 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Návrh databázy | Nastavenie PostgreSQL, návrh maloobchodnej schémy a ukážkové dáta | [Laboratórium 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.7 | Vývoj nástrojov | Tvorba nástrojov na dotazovanie databázy a introspekciu schémy | [Laboratórium 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
| 11.10 | Integrácia s VS Code | Konfigurácia integrácie MCP s VS Code a používanie AI Chat | [Laboratórium 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
| 11.13 | Najlepšie praktiky | Optimalizácia výkonu, posilnenie bezpečnosti a tipy pre produkciu | [Laboratórium 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
- Vizualizovanú mapu učebnej osnovy zobrazujúcu všetky pokryté témy
- Podrobný rozpis každej sekcie repozitára
- Pokyny, ako používať ukážkové projekty
- Odporúčané cesty učenia pre rôzne úrovne zručností
...
Je o posilnení vývojárov, aby používali MCP vo svojom vývojovom pracovnom postupe, a o oslave úžasnej MCP komunity. Pripojíme sa k členom komunity a partnerom, ako sú Arcade, Block, Okta a Neon, aby sme videli, ako spolupracujú s Microsoftom na formovaní otvoreného, rozšíriteľného MCP ekosystému. 
...
Či už len začínate s MCP alebo už s ním pracujete, Deň 1 nastaví scénu s inšpiráciou a praktickými poznatkami.
...
Ak ste vývojár, tvorca nástrojov alebo AI produktový stratég, tento deň je plný poznatkov, ktoré potrebujete na vytvorenie škálovateľných, bezpečných a budúcnosti odolných MCP riešení.
...
Poďme sa naučiť o Model Context Protocol (MCP), špičkovom rámci navrhnutom na štandardizáciu interakcií medzi AI modelmi a klientskými aplikáciami. Prostredníctvom tejto relácie priateľskej k začiatočníkom vás zoznámime s MCP a prevedieme vás vytvorením vášho prvého MCP servera.
...
- **11-MCPServerHandsOnLabs/**: Kompletná 13-laboratórna cesta učenia na vytvorenie produkčne pripravených MCP serverov s integráciou PostgreSQL
