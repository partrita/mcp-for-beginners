...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:39:14+00:00",
...
| 3.7 | Ferramentas de IA | Use ferramentas de IA com MCP | [Guia](./03-GettingStarted/07-aitk/README.md) |
...
| 11 | Integração de Banco de Dados do Servidor MCP | Caminho de aprendizado prático com 13 laboratórios para integração com PostgreSQL | [Laboratórios](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.10 | Integração com VS Code | Configurando integração do MCP com VS Code e uso de Chat AI | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
...
Mantemos um [Registro de Alterações](./changelog.md) detalhado que rastreia todas as atualizações significativas nos materiais do currículo, incluindo:
