...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:06:43+00:00",
...
| 11 | Integracija MCP Server baze podataka | Sveobuhvatan praktični put učenja kroz 13 laboratorija za integraciju PostgreSQL-a | [Laboratoriji](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Uvod | Pregled MCP-a s integracijom baze podataka i slučajem upotrebe analitike u maloprodaji | [Laboratorij 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.4 | Postavljanje okruženja | Postavljanje razvojnog okruženja, Docker-a, Azure resursa | [Laboratorij 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
...
| 11.10 | Integracija s VS Code | Konfiguriranje integracije MCP-a s VS Code i korištenje AI Chata | [Laboratorij 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | Strategije implementacije | Implementacija s Docker-om, Azure Container Apps i razmatranja skaliranja | [Laboratorij 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
| Java sa Spring-om | Primjer aplikacije u kontejneru | [Pogledaj kod](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
Posvećen je graditeljima MCP-a. Duboko ćemo zaroniti u strategije implementacije i najbolje prakse za stvaranje MCP servera i integraciju MCP-a u vaše AI tijekove rada.
...
Učite kroz intenzivne video sesije kako stvoriti MCP servere, integrirati s VS Code-om i profesionalno implementirati na Azure-u na temelju sadržaja iz MCP za početnike kurikuluma. Steknite praktične vještine u tehnologiji koju već koriste velike tvrtke.
...
Naučimo o Model Context Protocol-u (MCP), naprednom okviru dizajniranom za standardizaciju interakcija između AI modela i klijentskih aplikacija. Kroz ovu sesiju prilagođenu početnicima, upoznat ćemo vas s MCP-om i voditi vas kroz stvaranje vašeg prvog MCP servera.
...
Zahvaljujemo Microsoft Valued Professional-u [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) na doprinosu važnim uzorcima koda. 
...
Ugovorom o licenci za doprinos (CLA) koji izjavljuje da imate pravo i zapravo dajete prava za korištenje vašeg doprinosa. Za detalje, posjetite <https://cla.opensource.microsoft.com>.
...
- **Osnovni kurikulum (00-11)**: Glavni sadržaj organiziran u jedanaest sekvencijalnih modula, uključujući sveobuhvatne laboratorije za integraciju baze podataka
- **11-MCPServerHandsOnLabs/**: Kompletan put učenja kroz 13 laboratorija za izgradnju produkcijski spremnih MCP servera s integracijom PostgreSQL-a
