...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:20:25+00:00",
...
1. **تفرع المستودع**: انقر [![تفرعات GitHub](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
...
- 🧑‍💻 [مستودع GitHub الخاص بـ MCP](https://github.com/modelcontextprotocol) – أدوات مفتوحة المصدر وعينات من الأكواد  
...
| 3.10 | استخدام الخادم المتقدم | استخدام الخوادم المتقدمة لتحسين الميزات والهيكل | [الدليل](./03-GettingStarted/10-advanced/README.md) |
...
| 11 | تكامل قاعدة بيانات خادم MCP | مسار تعليمي عملي شامل يتكون من 13 مختبرًا لتكامل PostgreSQL | [المختبرات](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | الهيكل الأساسي | فهم بنية خادم MCP، طبقات قاعدة البيانات، وأنماط الأمان | [مختبر 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.10 | تكامل VS Code | إعداد تكامل MCP مع VS Code واستخدام الدردشة الذكية | [مختبر 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | استراتيجيات النشر | نشر باستخدام Docker، تطبيقات Azure Container، واعتبارات التوسع | [مختبر 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | المراقبة | رؤى التطبيقات، تسجيل الأحداث، ومراقبة الأداء | [مختبر 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
...
يدور حول تمكين المطورين من استخدام MCP في سير عملهم الاحترافي والاحتفال بالمجتمع الرائع لـ MCP. سنكون برفقة أعضاء المجتمع وشركاء مثل Arcade، Block، Okta، وNeon لرؤية كيف يتعاونون مع Microsoft لتشكيل نظام MCP مفتوح وقابل للتوسيع.  
...
### لنبدأ تعلم MCP مع C# - سلسلة تعليمية
لنتعلم عن بروتوكول سياق النموذج (MCP)، وهو إطار عمل متطور مصمم لتوحيد التفاعلات بين نماذج الذكاء الاصطناعي وتطبيقات العميل. من خلال هذه الجلسة المناسبة للمبتدئين، سنقدم لك MCP ونرشدك خلال إنشاء أول خادم MCP خاص بك.
...
شكرًا للمحترف المقدر من Microsoft [شيفام جويال](https://www.linkedin.com/in/shivam2003/) على مساهمته في نماذج الأكواد المهمة.
...
للحصول على مزيد من المعلومات، راجع [الأسئلة الشائعة حول مدونة قواعد السلوك](https://opensource.microsoft.com/codeofconduct/faq/) أو
...
- **المنهج الأساسي (00-11)**: المحتوى الرئيسي منظم في أحد عشر وحدة متتالية، بما في ذلك مختبرات تكامل قاعدة البيانات الشاملة
- **11-MCPServerHandsOnLabs/**: مسار تعليمي كامل يتكون من 13 مختبرًا لبناء خوادم MCP جاهزة للإنتاج مع تكامل PostgreSQL
...
- [إتقان GitHub Copilot للبرمجة المزدوجة باستخدام الذكاء الاصطناعي](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
