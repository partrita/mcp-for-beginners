...
- 🧑‍💻 [GitHub хранилище на MCP](https://github.com/modelcontextprotocol) – SDK-та с отворен код, инструменти и примери за код
...
| 11 | Интеграция на MCP сървър с база данни | Обширен учебен път с 13 практически лаборатории за интеграция с PostgreSQL | [Лаборатории](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Въведение | Преглед на MCP с интеграция на база данни и случай на употреба за анализ на търговията на дребно | [Лаборатория 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | Сигурност и многопотребителност | Сигурност на ниво ред, автентикация и достъп до данни за множество потребители | [Лаборатория 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Дизайн на база данни | Настройка на PostgreSQL, дизайн на схема за търговия на дребно и примерни данни | [Лаборатория 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.11 | Стратегии за внедряване | Внедряване с Docker, Azure Container Apps и мащабиране | [Лаборатория 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
- Запознаване с концепциите за REST и HTTP
...
Обширно [Учебно ръководство](./study_guide.md) е налично, за да ви помогне да се ориентирате в този репозиторий. Ръководството включва:
...
#### [Ден 1: MCP продуктивност, инструменти за разработка и общност:](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
Благодарности към Microsoft Valued Professional [Шивам Гоял](https://www.linkedin.com/in/shivam2003/) за важния принос с примерни кодове. 

## 📜 Информация за лиценз

Това съдържание е лицензирано под **MIT License**. За условия и разпоредби, вижте [LICENSE](../../LICENSE).
...
- **Основна учебна програма (00-11)**: Основното съдържание, организирано в единадесет последователни модула, включително обширни лаборатории за интеграция с база данни
- **11-MCPServerHandsOnLabs/**: Пълен учебен път с 13 лаборатории за изграждане на MCP сървъри, готови за продукция, с интеграция с PostgreSQL
...
- **study_guide.md**: Обширно ръководство за навигация в репозитория
...
Този проект може да съдържа търговски марки или лога на проекти, продукти или услуги. Разрешеното използване на търговски марки или лога на Microsoft трябва да се съобразява и да следва [Насоките за търговски марки и бранд на Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). 
