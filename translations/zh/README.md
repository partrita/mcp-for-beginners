...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:24:06+00:00",
...
## **通过 C#、Java、JavaScript、Rust、Python 和 TypeScript 的实践代码示例学习 MCP**

## 🧠 模型上下文协议课程概述

**模型上下文协议（MCP）** 是一个前沿框架，旨在标准化 AI 模型与客户端应用程序之间的交互。本开源课程提供了一个结构化的学习路径，包含实践编码示例和真实案例，涵盖 C#、Java、JavaScript、TypeScript 和 Python 等流行编程语言。
...
| 03 | MCP 入门 | 环境设置、基本服务器/客户端、集成 | [阅读更多](./03-GettingStarted/README.md) |
| **模块 3：构建您的第一个服务器和客户端** | | | |
| 3.1 | 第一个服务器 | 创建您的第一个 MCP 服务器 | [指南](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | 第一个客户端 | 开发一个基础的 MCP 客户端 | [指南](./03-GettingStarted/02-client/README.md) |
...
| 3.11 | 简单认证 | 从基础开始展示认证和基于角色的访问控制（RBAC） | [指南](./03-GettingStarted/11-simple-auth/README.md) |
| **模块 4-5：实践与高级主题** | | | |
| 04 | 实践实施 | SDK、调试、测试、可重用的提示模板 | [阅读更多](./04-PracticalImplementation/README.md) |
...
| 5.2 | 多模态 | 使用多模态 | [指南](./05-AdvancedTopics/mcp-multi-modality/README.md) |
...
| **模块 11：MCP 服务器实践实验** | | | |
| 11 | MCP服务器数据库集成 | PostgreSQL集成的综合13个实验动手学习路径 | [实验](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | 介绍 | MCP与数据库集成及零售分析用例概述 | [实验 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.7 | 工具开发 | 创建数据库查询工具和模式自省工具 | [实验 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
提供了一个全面的[学习指南](./study_guide.md)，帮助您有效地浏览本仓库。指南包括：
...
准备好迎接两天的深度技术洞察、社区连接和动手学习吧！MCP开发者日是一个虚拟活动，专注于模型上下文协议（MCP）——连接AI模型及其依赖工具的新兴标准。
...
- 展示VS Code、Visual Studio、GitHub Copilot和流行社区工具的真实案例  
- 实用的、上下文驱动的开发工作流  
- 社区主导的会议和洞察  
...
如果您是开发者、工具构建者或AI产品策略师，这一天将为您提供构建可扩展、安全且面向未来的MCP解决方案所需的洞察。

### MCP训练营 2025年8月
通过密集的视频课程学习如何创建MCP服务器、集成VS Code，并基于MCP初学者课程内容在Azure上专业部署。掌握主要公司已经在使用的技术的实用技能。
...
### 学习MCP教程系列
了解模型上下文协议（MCP），一个旨在标准化AI模型与客户端应用交互的前沿框架。在这个面向初学者的课程中，我们将向您介绍MCP，并指导您创建第一个MCP服务器。
...
感谢微软优秀专业人士[Shivam Goyal](https://www.linkedin.com/in/shivam2003/)为本项目贡献了重要代码示例。
