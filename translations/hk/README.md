...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:26:08+00:00",
...
## **通過 C#、Java、JavaScript、Rust、Python 和 TypeScript 的實作代碼範例學習 MCP**

## 🧠 模型上下文協議課程概覽

**模型上下文協議（MCP）** 是一個尖端框架，旨在標準化 AI 模型與客戶端應用程式之間的互動。這個開源課程提供了一條結構化的學習路徑，包含實用的編碼範例和真實案例，涵蓋 C#、Java、JavaScript、TypeScript 和 Python 等流行程式語言。

無論你是 AI 開發者、系統架構師還是軟件工程師，這份指南都是你掌握 MCP 基礎知識和實作策略的全面資源。

## 🔗 官方 MCP 資源

- 📘 [MCP 文件](https://modelcontextprotocol.io/) – 詳細教程和用戶指南  
- 📜 [MCP 規範](https://modelcontextprotocol.io/docs/) – 協議架構和技術參考  
- 📜 [原始 MCP 規範](https://spec.modelcontextprotocol.io/) – 傳統技術參考（可能包含更多細節）  
- 🧑‍💻 [MCP GitHub 儲存庫](https://github.com/modelcontextprotocol) – 開源 SDK、工具和代碼範例
...
| 02 | MCP 的安全性 | 安全威脅與最佳實踐 | [了解更多](./02-Security/README.md) |
...
| 5.14 | 上下文工程 | 有效進行上下文工程的技術 | [指南](./05-AdvancedTopics/mcp-contextengineering/README.md) |
...
| **模組 11：MCP 伺服器實作實驗室** | | | |
| 11 | MCP 伺服器資料庫整合 | 針對 PostgreSQL 整合的完整 13 個實驗手動學習路徑 | [實驗](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | 簡介 | MCP 與資料庫整合及零售分析案例的概述 | [實驗 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.5 | 資料庫設計 | PostgreSQL 設置、零售架構設計及範例資料 | [實驗 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | MCP 伺服器實現 | 建立與資料庫整合的 FastMCP 伺服器 | [實驗 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | 工具開發 | 創建資料庫查詢工具及架構檢視 | [實驗 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
| 11.13 | 最佳實踐 | 性能優化、安全加固及生產提示 | [實驗 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
準備好參加為期兩天的深入技術洞察、社群連結及實作學習的 MCP 開發日虛擬活動，專注於模型上下文協議（MCP）——一個連接 AI 模型及其依賴工具的新興標準。
...
第一天旨在幫助開發者將 MCP 融入其開發工作流程，並慶祝 MCP 社群的卓越成就。我們將與社群成員及合作夥伴如 Arcade、Block、Okta 和 Neon 一起探討他們如何與 Microsoft 合作，共同塑造開放、可擴展的 MCP 生態系統。  
實際案例展示 VS Code、Visual Studio、GitHub Copilot 及流行社群工具  
實用的上下文驅動開發工作流程  
社群主導的會議及洞察  
...
第二天專為 MCP 建設者設計。我們將深入探討構建 MCP 伺服器及將 MCP 整合到 AI 工作流程中的實現策略及最佳實踐。
...
### MCP 訓練營 2025 年 8 月
透過密集的視頻課程學習如何建立 MCP 伺服器、整合 VS Code 及基於 MCP 初學者課程內容在 Azure 上專業部署。掌握主要公司已經使用的技術的實用技能。
...
### MCP 學習系列 - C# 教程
了解模型上下文協議（MCP），一個旨在標準化 AI 模型與客戶端應用之間交互的尖端框架。透過此適合初學者的課程，我們將向您介紹 MCP 並指導您建立第一個 MCP 伺服器。
...
此內容依 **MIT 授權** 授權。條款及條件請參閱 [LICENSE](../../LICENSE)。
...
此項目可能包含與項目、產品或服務相關的商標或標誌。使用 Microsoft 商標或標誌需獲得授權，並必須遵守 [Microsoft 的商標與品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。  
