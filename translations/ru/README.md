...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:19:14+00:00",
...
| **Модуль 11: Практическая лаборатория сервера MCP** | | | |
| 11 | Интеграция базы данных MCP Server | Полный учебный путь из 13 лабораторных работ по интеграции PostgreSQL | [Лаборатории](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.3 | Безопасность и многопользовательский доступ | Управление доступом на уровне строк, аутентификация и многопользовательский доступ к данным | [Лаборатория 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
Доступно подробное [Учебное пособие](./study_guide.md), которое поможет вам эффективно ориентироваться в репозитории. В пособии содержится:
...
- Рекомендуемые учебные пути для разных уровней подготовки
...
- Создание серверов MCP и их интеграция в агентные системы
...
Изучите в интенсивных видеосессиях, как создавать серверы MCP, интегрировать их с VS Code и профессионально развертывать на Azure, основываясь на материалах курса MCP для начинающих. Получите практические навыки в технологии, которую уже используют крупные компании.
...
Давайте изучим Model Context Protocol (MCP), передовую платформу, разработанную для стандартизации взаимодействий между AI-моделями и клиентскими приложениями. В этом дружелюбном для новичков уроке мы познакомим вас с MCP и покажем, как создать ваш первый сервер MCP.  
...
- **Основной курс (00-11)**: Основной контент, организованный в одиннадцать последовательных модулей, включая полные лабораторные работы по интеграции базы данных
- **11-MCPServerHandsOnLabs/**: Полный учебный путь из 13 лабораторных работ для создания готовых к продакшену серверов MCP с интеграцией PostgreSQL
...
Этот проект может содержать товарные знаки или логотипы, связанные с проектами, продуктами или услугами. Разрешенное использование товарных знаков или логотипов Microsoft должно соответствовать и следовать [Руководству по использованию товарных знаков и брендов Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Использование товарных знаков или логотипов Microsoft в измененных версиях этого проекта не должно вызывать путаницу или подразумевать спонсорство со стороны Microsoft. Любое использование товарных знаков или логотипов третьих сторон должно соответствовать политике этих сторон.
