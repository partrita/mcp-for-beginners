...
| 3.3 | ไคลเอนต์ที่มี LLM | ผสานรวมโมเดลภาษาขนาดใหญ่ | [คู่มือ](./03-GettingStarted/03-llm-client/README.md) |
...
| 11 | การรวมฐานข้อมูล MCP Server | เส้นทางการเรียนรู้แบบลงมือปฏิบัติ 13 ห้องปฏิบัติการสำหรับการรวม PostgreSQL | [Labs](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | บทนำ | ภาพรวมของ MCP พร้อมการรวมฐานข้อมูลและกรณีศึกษาเกี่ยวกับการวิเคราะห์การค้าปลีก | [Lab 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | สถาปัตยกรรมหลัก | ทำความเข้าใจสถาปัตยกรรม MCP Server, ชั้นฐานข้อมูล และรูปแบบความปลอดภัย | [Lab 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | ความปลอดภัยและการใช้งานหลายผู้เช่า | Row Level Security, การตรวจสอบสิทธิ์ และการเข้าถึงข้อมูลหลายผู้เช่า | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | การออกแบบฐานข้อมูล | การตั้งค่า PostgreSQL, การออกแบบโครงสร้างการค้าปลีก และข้อมูลตัวอย่าง | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | การพัฒนา MCP Server | การสร้าง FastMCP Server พร้อมการรวมฐานข้อมูล | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | การพัฒนาเครื่องมือ | การสร้างเครื่องมือสอบถามฐานข้อมูลและการตรวจสอบโครงสร้าง | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
...
| 11.9 | การทดสอบและการแก้ไขข้อผิดพลาด | กลยุทธ์การทดสอบ, เครื่องมือแก้ไขข้อผิดพลาด, และวิธีการตรวจสอบ | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
...
| 11.11 | กลยุทธ์การปรับใช้ | การปรับใช้ Docker, Azure Container Apps, และการพิจารณาการขยายระบบ | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
...
มี [คู่มือการเรียนรู้](./study_guide.md) ที่ครอบคลุมเพื่อช่วยให้คุณสำรวจที่เก็บนี้ได้อย่างมีประสิทธิภาพ คู่มือประกอบด้วย:
...
เตรียมตัวให้พร้อมสำหรับสองวันของข้อมูลเชิงลึกทางเทคนิค, การเชื่อมต่อชุมชน, และการเรียนรู้แบบลงมือปฏิบัติใน MCP Dev Days ซึ่งเป็นงานเสมือนจริงที่อุทิศให้กับ Model Context Protocol (MCP) — มาตรฐานใหม่ที่เชื่อมโยงโมเดล AI และเครื่องมือที่พวกเขาใช้งาน
...
เน้นการเพิ่มพลังให้กับนักพัฒนาในการใช้ MCP ในกระบวนการพัฒนาและเฉลิมฉลองชุมชน MCP ที่น่าทึ่ง เราจะร่วมกับสมาชิกชุมชนและพันธมิตร เช่น Arcade, Block, Okta, และ Neon เพื่อดูว่าพวกเขาร่วมมือกับ Microsoft อย่างไรในการสร้างระบบนิเวศ MCP ที่เปิดกว้างและขยายได้
...
เรียนรู้ในเซสชันวิดีโอเข้มข้นเกี่ยวกับวิธีสร้าง MCP Servers, การรวมเข้ากับ VS Code, และการปรับใช้อย่างมืออาชีพบน Azure โดยอิงจากเนื้อหาหลักสูตร MCP สำหรับผู้เริ่มต้น ออกไปพร้อมทักษะที่ใช้งานได้จริงในเทคโนโลยีที่บริษัทใหญ่ๆ กำลังใช้งานอยู่
...
ใช้การมีส่วนร่วมของคุณ สำหรับรายละเอียด โปรดเยี่ยมชม <https://cla.opensource.microsoft.com>
...
ที่บอทให้ คุณจะต้องทำสิ่งนี้เพียงครั้งเดียวสำหรับทุก repo ที่ใช้ CLA ของเรา
