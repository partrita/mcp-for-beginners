...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:38:09+00:00",
...
| 11 | Integração de Base de Dados do Servidor MCP | Percurso de aprendizagem prático com 13 laboratórios sobre integração com PostgreSQL | [Laboratórios](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | Introdução | Visão geral do MCP com integração de base de dados e caso de uso em análise de retalho | [Laboratório 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | Arquitetura Principal | Compreender a arquitetura do servidor MCP, camadas de base de dados e padrões de segurança | [Laboratório 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | Segurança e Multi-Tenancy | Segurança ao nível de linhas, autenticação e acesso a dados multi-inquilino | [Laboratório 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
...
| 11.5 | Design de Base de Dados | Configuração do PostgreSQL, design de esquema de retalho e dados de exemplo | [Laboratório 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | Implementação do Servidor MCP | Construção do servidor FastMCP com integração de base de dados | [Laboratório 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | Desenvolvimento de Ferramentas | Criação de ferramentas de consulta de base de dados e introspeção de esquema | [Laboratório 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | Pesquisa Semântica | Implementação de embeddings vetoriais com Azure OpenAI e pgvector | [Laboratório 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
| 11.9 | Testes e Depuração | Estratégias de teste, ferramentas de depuração e abordagens de validação | [Laboratório 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | Integração com VS Code | Configuração da integração do MCP com VS Code e uso de Chat AI | [Laboratório 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | Estratégias de Implementação | Implementação com Docker, Azure Container Apps e considerações de escalabilidade | [Laboratório 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | Monitorização | Application Insights, registo de logs, monitorização de desempenho | [Laboratório 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | Melhores Práticas | Otimização de desempenho, reforço de segurança e dicas para produção | [Laboratório 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
- **11-MCPServerHandsOnLabs/**: Percurso de aprendizagem completo com 13 laboratórios para construir servidores MCP prontos para produção com integração PostgreSQL
...
Se tiveres dificuldades ou perguntas sobre como criar aplicações de IA, junta-te a:
