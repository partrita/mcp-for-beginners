...
چاہے آپ AI ڈویلپر ہوں، سسٹم آرکیٹیکٹ، یا سافٹ ویئر انجینئر، یہ گائیڈ MCP کی بنیادی باتوں اور نفاذ کی حکمت عملیوں کو سیکھنے کے لیے آپ کا جامع ذریعہ ہے۔
...
| 3.10 | جدید سرور کا استعمال | جدید فیچر کے استعمال اور بہتر ساخت کے لیے جدید سرورز کا استعمال کریں | [گائیڈ](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | سادہ تصدیق | ایک باب جو آپ کو ابتدائی تصدیق اور RBAC دکھاتا ہے | [گائیڈ](./03-GettingStarted/11-simple-auth/README.md) |
...
| 5.8 | سیکیورٹی | جدید سیکیورٹی کے تحفظات | [گائیڈ](./05-AdvancedTopics/mcp-security/README.md) |
...
| 11 | ایم سی پی سرور ڈیٹا بیس انٹیگریشن | PostgreSQL انٹیگریشن کے لیے جامع 13-لیبز عملی سیکھنے کا راستہ | [لیبز](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | تعارف | ڈیٹا بیس انٹیگریشن اور ریٹیل اینالیٹکس کے استعمال کے کیس کے ساتھ ایم سی پی کا جائزہ | [لیب 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | بنیادی آرکیٹیکچر | ایم سی پی سرور آرکیٹیکچر، ڈیٹا بیس لیئرز، اور سیکیورٹی پیٹرنز کو سمجھنا | [لیب 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
| 11.4 | ماحول کی ترتیب | ڈیولپمنٹ ماحول، ڈوکر، اور ایزور وسائل کی ترتیب | [لیب 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
...
| 11.6 | ایم سی پی سرور کا نفاذ | ڈیٹا بیس انٹیگریشن کے ساتھ فاسٹ ایم سی پی سرور بنانا | [لیب 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
...
| 11.11 | ڈپلائمنٹ کی حکمت عملی | ڈوکر ڈپلائمنٹ، ایزور کنٹینر ایپس، اور اسکیلنگ کے پہلو | [لیب 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | مانیٹرنگ | ایپلیکیشن انسائٹس، لاگنگ، پرفارمنس مانیٹرنگ | [لیب 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | بہترین طریقے | پرفارمنس آپٹیمائزیشن، سیکیورٹی کو مضبوط بنانا، اور پروڈکشن کے مشورے | [لیب 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
#### ایڈوانسڈ ایم سی پی امپلیمنٹیشنز

| زبان | تفصیل | لنک |
|------|-------|------|
| C# | ایڈوانسڈ نمونہ | [کوڈ دیکھیں](./04-PracticalImplementation/samples/csharp/README.md) |
| جاوا ود اسپرنگ | کنٹینر ایپ کی مثال | [کوڈ دیکھیں](./04-PracticalImplementation/samples/java/containerapp/README.md) |
...
- مدد کے لیے ہماری کمیونٹی ڈسکشنز میں شامل ہوں  
...
دو دن کی گہری تکنیکی بصیرت، کمیونٹی کنکشن، اور عملی سیکھنے کے لیے تیار ہو جائیں ایم سی پی ڈیولپر ڈیز میں، جو کہ ماڈل کانٹیکسٹ پروٹوکول (MCP) کے لیے وقف ایک ورچوئل ایونٹ ہے — جو کہ ابھرتا ہوا معیار ہے جو AI ماڈلز اور ان کے استعمال کے اوزاروں کو جوڑتا ہے۔  
...
یہ دن ڈویلپرز کو ان کے ڈیولپمنٹ ورک فلو میں ایم سی پی استعمال کرنے کے قابل بنانے اور شاندار ایم سی پی کمیونٹی کا جشن منانے کے بارے میں ہے۔ ہم کمیونٹی کے اراکین اور شراکت داروں جیسے آرکیڈ، بلاک، اوکتا، اور نیون کے ساتھ شامل ہوں گے تاکہ یہ دیکھ سکیں کہ وہ مائیکروسافٹ کے ساتھ مل کر ایک کھلا، توسیع پذیر ایم سی پی ایکو سسٹم کیسے تشکیل دے رہے ہیں۔  
...
چاہے آپ ایم سی پی کے ساتھ ابھی شروعات کر رہے ہوں یا پہلے سے اس کے ساتھ کام کر رہے ہوں، پہلا دن آپ کو تحریک اور قابل عمل نتائج کے ساتھ تیار کرے گا۔  

#### [دوسرا دن: اعتماد کے ساتھ ایم سی پی سرورز بنائیں](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

یہ دن ایم سی پی بنانے والوں کے لیے ہے۔ ہم ایم سی پی سرورز بنانے اور ایم سی پی کو آپ کے AI ورک فلو میں ضم کرنے کے لیے نفاذ کی حکمت عملیوں اور بہترین طریقوں میں گہرائی سے جائیں گے۔  
...
اگر آپ ایک ڈویلپر، ٹول بلڈر، یا AI پروڈکٹ اسٹریٹجسٹ ہیں، تو یہ دن آپ کو اس بصیرت سے بھر دے گا جس کی آپ کو اسکیل ایبل، محفوظ، اور مستقبل کے لیے تیار ایم سی پی حل بنانے کی ضرورت ہے۔  

### ایم سی پی بوٹ کیمپ اگست 2025
ویڈیو سیشنز میں سیکھیں کہ ایم سی پی سرورز کیسے بنائیں، وی ایس کوڈ کے ساتھ انٹیگریٹ کریں، اور ایم سی پی فار بیگنرز نصاب کے مواد کی بنیاد پر ایزور پر پیشہ ورانہ طور پر ڈپلائے کریں۔ ایک ایسی ٹیکنالوجی میں عملی مہارت کے ساتھ واپس جائیں جسے بڑی کمپنیاں پہلے ہی استعمال کر رہی ہیں۔  
...
### آئیے ایم سی پی کو سی شارپ کے ساتھ سیکھیں - ٹیوٹوریل سیریز
آئیے ماڈل کانٹیکسٹ پروٹوکول (MCP) کے بارے میں سیکھیں، جو ایک جدید فریم ورک ہے جو AI ماڈلز اور کلائنٹ ایپلیکیشنز کے درمیان تعامل کو معیاری بنانے کے لیے ڈیزائن کیا گیا ہے۔ اس ابتدائی دوستانہ سیشن کے ذریعے، ہم آپ کو ایم سی پی سے متعارف کرائیں گے اور آپ کو آپ کا پہلا ایم سی پی سرور بنانے کی رہنمائی کریں گے۔  
...
مائیکروسافٹ ویلیوڈ پروفیشنل [شِوم گوئل](https://www.linkedin.com/in/shivam2003/) کا شکریہ جنہوں نے اہم کوڈ نمونوں میں تعاون کیا۔  

## 📜 لائسنس کی معلومات

یہ مواد **MIT لائسنس** کے تحت لائسنس یافتہ ہے۔ شرائط و ضوابط کے لیے، [لائسنس](../../LICENSE) دیکھیں۔  

## 🤝 تعاون کے رہنما اصول

یہ پروجیکٹ تعاون اور تجاویز کا خیرمقدم کرتا ہے۔ زیادہ تر تعاون کے لیے آپ کو ایک  
Contributor License Agreement (CLA) پر اتفاق کرنا ہوگا، جس میں یہ اعلان کیا جائے گا کہ آپ کے پاس اپنے تعاون کے حقوق دینے کا حق ہے، اور آپ واقعی ایسا کرتے ہیں۔ تفصیلات کے لیے، <https://cla.opensource.microsoft.com> ملاحظہ کریں۔  

جب آپ ایک پل ریکویسٹ جمع کراتے ہیں، تو ایک CLA بوٹ خود بخود یہ تعین کرے گا کہ آیا آپ کو CLA فراہم کرنے کی ضرورت ہے اور PR کو مناسب طریقے سے سجائے گا (مثلاً، اسٹیٹس چیک، تبصرہ)۔ بس بوٹ کی طرف سے فراہم کردہ ہدایات پر عمل کریں۔ آپ کو یہ صرف ایک بار تمام ریپوز کے لیے کرنا ہوگا جو ہمارے CLA کا استعمال کرتے ہیں۔  
...
ریپوزٹری اس طرح منظم ہے:

- **کور نصاب (00-11)**: گیارہ تسلسل وار ماڈیولز میں منظم بنیادی مواد، بشمول جامع ڈیٹا بیس انٹیگریشن لیبز  
- **11-MCPServerHandsOnLabs/**: PostgreSQL انٹیگریشن کے ساتھ پروڈکشن کے لیے تیار ایم سی پی سرورز بنانے کے لیے مکمل 13-لیب سیکھنے کا راستہ  
...
- [**نیا** ابتدائیوں کے لیے ایج اے آئی](https://github.com/microsoft/edgeai-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [ابتدائیوں کے لیے اے آئی ایجنٹس](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [ابتدائیوں کے لیے جنریٹو اے آئی .NET کے ساتھ](https://github.com/microsoft/Generative-AI-for-beginners-dotnet?WT.mc_id=academic-105485-koreyst)  
- [جنریٹو اے آئی ابتدائیوں کے لیے جاوا اسکرپٹ کے ساتھ](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)  
- [ابتدائیوں کے لیے جنریٹو اے آئی](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)  
- [ابتدائیوں کے لیے جنریٹو اے آئی جاوا کے ساتھ](https://github.com/microsoft/generative-ai-for-beginners-java?WT.mc_id=academic-105485-koreyst)  
...
- [ابتدائیوں کے لیے اے آئی](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)  
- [ابتدائیوں کے لیے سائبر سیکیورٹی](https://github.com/microsoft/Security
...
کی پیروی کرنی ہوگی۔ اس پروجیکٹ کے ترمیم شدہ ورژنز میں Microsoft کے ٹریڈ مارکس یا لوگوز کا استعمال الجھن پیدا نہیں کرنا چاہیے یا Microsoft کی اسپانسرشپ کا اشارہ نہیں دینا چاہیے۔ کسی بھی تیسرے فریق کے ٹریڈ مارکس یا لوگوز کا استعمال ان کے متعلقہ پالیسیوں کے تابع ہوگا۔
