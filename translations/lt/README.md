...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:11:26+00:00",
...
**Modelio konteksto protokolas (MCP)** yra pažangus pagrindas, skirtas standartizuoti sąveiką tarp AI modelių ir klientų programų. Ši atvirojo kodo mokymo programa siūlo struktūruotą mokymosi kelią su praktiniais kodavimo pavyzdžiais ir realaus pasaulio naudojimo atvejais, naudojant populiarias programavimo kalbas, tokias kaip C#, Java, JavaScript, TypeScript ir Python.
...
| 3.11 | Paprastas autentifikavimas | Skyrius, parodantis autentifikavimą nuo pradžių ir RBAC | [Vadovas](./03-GettingStarted/11-simple-auth/README.md) |
...
| 11.1 | Įvadas | MCP apžvalga su duomenų bazės integracija ir mažmeninės prekybos analitikos panaudojimo atveju | [Laboratorija 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
Norint maksimaliai išnaudoti šią mokymo programą, turėtumėte:
...
- Susipažinti su REST ir HTTP koncepcijomis
- (Pasirinktinai) Turėti AI/ML koncepcijų pagrindą

- Prisijungti prie mūsų bendruomenės diskusijų, kad gautumėte pagalbos
...
Praktiški, kontekstiniai kūrimo darbo srautai
...
Skirta MCP kūrėjams. Gilinamės į įgyvendinimo strategijas ir geriausias praktikas, kaip kurti MCP serverius ir integruoti MCP į AI darbo eigas.
...
Jei esate kūrėjas, įrankių kūrėjas ar AI produktų strategas, ši diena bus kupina įžvalgų, reikalingų kurti mastelio didinimui, saugius ir ateities MCP sprendimus.

### MCP Boot Camp 2025 m. rugpjūtis
Intensyvių vaizdo sesijų metu sužinokite, kaip kurti MCP serverius, integruoti su VS Code ir profesionaliai diegti Azure pagrindu, remiantis MCP pradedančiųjų mokymo programa. Išmokite praktinių įgūdžių technologijoje, kurią jau naudoja didelės įmonės.
...
CLA ir pažymės PR atitinkamai (pvz., statuso patikrinimas, komentaras). Tiesiog vykdykite bot pateiktas instrukcijas. Tai reikės padaryti tik vieną kartą visose saugyklose, naudojančiose mūsų CLA.
...
- **Pagrindinė mokymo programa (00-11)**: Pagrindinis turinys, suskirstytas į vienuolika nuoseklių modulių, įskaitant išsamias laboratorijas duomenų bazės integracijai
...
„Microsoft“ prekių ženklų ar logotipų naudojimas modifikuotose šio projekto versijose neturi sukelti painiavos ar sudaryti įspūdžio, kad projektą remia „Microsoft“.  
