...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:21:38+00:00",
...
## 🧠 نمای کلی برنامه آموزشی پروتکل زمینه مدل
...
چه شما یک توسعه‌دهنده هوش مصنوعی، معمار سیستم یا مهندس نرم‌افزار باشید، این راهنما منبع جامع شما برای تسلط بر اصول MCP و استراتژی‌های پیاده‌سازی آن است.
...
| 00 | معرفی MCP | نمای کلی پروتکل زمینه مدل و اهمیت آن در خطوط هوش مصنوعی | [بیشتر بخوانید](./00-Introduction/README.md) |
...
| 11 | یکپارچه‌سازی پایگاه داده سرور MCP | مسیر یادگیری جامع 13 آزمایش عملی برای یکپارچه‌سازی PostgreSQL | [آزمایش‌ها](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | مقدمه | مروری بر MCP با یکپارچه‌سازی پایگاه داده و مورد استفاده در تحلیل خرده‌فروشی | [آزمایش 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.3 | امنیت و چندمستاجری | امنیت در سطح ردیف، احراز هویت و دسترسی به داده‌های چندمستاجری | [آزمایش 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | راه‌اندازی محیط | راه‌اندازی محیط توسعه، داکر و منابع Azure | [آزمایش 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
| 11.5 | طراحی پایگاه داده | راه‌اندازی PostgreSQL، طراحی طرح خرده‌فروشی و داده‌های نمونه | [آزمایش 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
...
| 11.8 | جستجوی معنایی | پیاده‌سازی بردارهای جاسازی با Azure OpenAI و pgvector | [آزمایش 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
...
| 11.10 | یکپارچه‌سازی با VS Code | پیکربندی یکپارچه‌سازی MCP با VS Code و استفاده از چت هوش مصنوعی | [آزمایش 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | استراتژی‌های استقرار | استقرار با داکر، Azure Container Apps و ملاحظات مقیاس‌پذیری | [آزمایش 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | نظارت | Application Insights، ثبت لاگ‌ها و نظارت بر عملکرد | [آزمایش 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | بهترین شیوه‌ها | بهینه‌سازی عملکرد، تقویت امنیت و نکات تولیدی | [آزمایش 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
| جاوا با Spring | نمونه برنامه کانتینری | [مشاهده کد](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| جاوااسکریپت | نمونه پیشرفته | [مشاهده کد](./04-PracticalImplementation/samples/javascript/README.md) |
| پایتون | پیاده‌سازی پیچیده | [مشاهده کد](../../04-PracticalImplementation/samples/python/READMEmd) |
| تایپ‌اسکریپت | نمونه کانتینری | [مشاهده کد](./04-PracticalImplementation/samples/typescript/README.md) |

## 🎯 پیش‌نیازهای یادگیری MCP

برای بهره‌برداری کامل از این دوره، باید:

- دانش پایه‌ای از برنامه‌نویسی در حداقل یکی از زبان‌های زیر داشته باشید: C#، جاوا، جاوااسکریپت، پایتون یا تایپ‌اسکریپت  
...
این مخزن شامل منابع متعددی است که به شما کمک می‌کند به طور مؤثر یاد بگیرید:
...
ما یک [تغییرات](./changelog.md) دقیق را نگهداری می‌کنیم که تمام به‌روزرسانی‌های مهم در مواد درسی را پیگیری می‌کند، از جمله:
...
### [روزهای توسعه‌دهندگان MCP جولای 2025](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
#### [➡️تماشای درخواستی - روزهای توسعه‌دهندگان MCP](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
آماده شوید برای دو روز بینش فنی عمیق، ارتباط با جامعه و یادگیری عملی در روزهای توسعه‌دهندگان MCP، یک رویداد مجازی که به پروتکل مدل کانتکست (MCP) اختصاص دارد — استاندارد نوظهوری که مدل‌های هوش مصنوعی و ابزارهایی که به آن‌ها وابسته هستند را به هم متصل می‌کند.  
...
این روز به توانمندسازی توسعه‌دهندگان برای استفاده از MCP در جریان کاری توسعه‌دهنده و جشن گرفتن جامعه شگفت‌انگیز MCP اختصاص دارد. ما با اعضای جامعه و شرکایی مانند Arcade، Block، Okta و Neon همراه خواهیم شد تا ببینیم چگونه با مایکروسافت همکاری می‌کنند تا یک اکوسیستم MCP باز و قابل گسترش را شکل دهند.  
...
چه تازه با MCP آشنا شده باشید یا در حال حاضر با آن کار می‌کنید، روز اول با الهام و نکات عملی زمینه را فراهم می‌کند.  

#### [روز دوم: ساخت سرورهای MCP با اطمینان](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

این روز برای سازندگان MCP است. ما به استراتژی‌های پیاده‌سازی و بهترین شیوه‌ها برای ایجاد سرورهای MCP و یکپارچه‌سازی MCP در جریان‌های کاری هوش مصنوعی خواهیم پرداخت.  
...
در جلسات ویدیویی فشرده یاد بگیرید چگونه سرورهای MCP ایجاد کنید، با VS Code یکپارچه شوید و به صورت حرفه‌ای در Azure مستقر شوید، بر اساس محتوای دوره MCP برای مبتدیان. با مهارت‌های عملی در فناوری که شرکت‌های بزرگ در حال حاضر از آن استفاده می‌کنند، از این دوره خارج شوید.  
...
#### جاوااسکریپت: [https://aka.ms/letslearnmcp-javascript](https://aka.ms/letslearnmcp-javascript)  
#### پایتون: [https://aka.ms/letslearnmcp-python](https://aka.ms/letslearnmcp-python)  
...
توافق‌نامه مجوز مشارکت‌کننده (CLA) موافقت کنید که اعلام می‌کند شما حق دارید و در واقع به ما  
حقوق استفاده از مشارکت خود را اعطا می‌کنید. برای جزئیات، به <https://cla.opensource.microsoft.com> مراجعه کنید.  

هنگامی که یک درخواست pull ارسال می‌کنید، یک ربات CLA به طور خودکار تعیین می‌کند که آیا شما نیاز به ارائه  
CLA دارید و درخواست را به درستی تزئین می‌کند (مثلاً بررسی وضعیت، نظر). به سادگی دستورالعمل‌های  
ارائه شده توسط ربات را دنبال کنید. شما فقط یک بار نیاز به انجام این کار دارید برای تمام مخازن  
که از CLA ما استفاده می‌کنند.  
...
- **برنامه درسی اصلی (00-11)**: محتوای اصلی که در یازده ماژول متوالی سازماندهی شده است، شامل آزمایش‌های جامع یکپارچه‌سازی پایگاه داده  
- **11-MCPServerHandsOnLabs/**: مسیر یادگیری کامل 13 آزمایش برای ساخت سرورهای MCP آماده تولید با یکپارچه‌سازی PostgreSQL  
...
اگر در جایی گیر کردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، به اینجا بپیوندید:  
