...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:43:58+00:00",
...
| 3.11 | Απλή αυθεντικοποίηση | Ένα κεφάλαιο που σας δείχνει αυθεντικοποίηση από την αρχή και RBAC | [Οδηγός](./03-GettingStarted/11-simple-auth/README.md) |
| **Ενότητα 4-5: Πρακτική & Προχωρημένη** | | | |
...
| 5.12 | Αυθεντικοποίηση με Entra ID | Αυθεντικοποίηση με Microsoft Entra ID | [Οδηγός](./05-AdvancedTopics/mcp-security-entra/README.md) |
...
| 06 | Συμβολές στην Κοινότητα | Πώς να συμβάλετε στο οικοσύστημα MCP | [Οδηγός](./06-CommunityContributions/README.md) |
...
| 11 | Ενσωμάτωση Βάσης Δεδομένων MCP Server | Ολοκληρωμένη εκπαιδευτική διαδρομή 13 εργαστηρίων για ενσωμάτωση PostgreSQL | [Εργαστήρια](./11-MCPServerHandsOnLabs/README.md) |
...
| 11.2 | Βασική Αρχιτεκτονική | Κατανόηση της αρχιτεκτονικής του MCP server, των επιπέδων βάσης δεδομένων και των προτύπων ασφαλείας | [Εργαστήριο 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
...
Ένας ολοκληρωμένος [Οδηγός Μελέτης](./study_guide.md) είναι διαθέσιμος για να σας βοηθήσει να πλοηγηθείτε αποτελεσματικά στο αποθετήριο. Ο οδηγός περιλαμβάνει:
...
#### [Ημέρα 2: Δημιουργήστε MCP Servers με Σιγουριά](https://developer.microsoft.com/en-us/reactor/series/S-1563/)
...
- **11-MCPServerHandsOnLabs/**: Ολοκληρωμένη εκπαιδευτική διαδρομή 13 εργαστηρίων για τη δημιουργία MCP servers έτοιμων για παραγωγή με ενσωμάτωση PostgreSQL
...
- [
- [Κατανόηση του GitHub Copilot για Συνεργατικό Προγραμματισμό με AI](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)  
