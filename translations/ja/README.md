...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:28:20+00:00",
...
## **C#、Java、JavaScript、Rust、Python、TypeScriptのコード例でMCPを学ぶ**
...
- 📜 [オリジナルMCP仕様](https://spec.modelcontextprotocol.io/) – 従来の技術的参考資料 (追加の詳細が含まれる場合があります)  
...
| 3.10 | 高度なサーバー使用 | 高度な機能と改善されたアーキテクチャのためのサーバー使用 | [ガイド](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | シンプル認証 | 認証の基本とRBACを示す章 | [ガイド](./03-GettingStarted/11-simple-auth/README.md) |
| **モジュール4-5: 実践 & 高度な内容** | | | |
...
| **モジュール11: MCPサーバー実践ラボ** | | | |
| 11 | MCPサーバーデータベース統合 | PostgreSQL統合のための包括的な13ラボの実践学習パス | [Labs](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | はじめに | データベース統合と小売分析のユースケースを含むMCPの概要 | [Lab 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
...
| 11.4 | 環境設定 | 開発環境、Docker、Azureリソースのセットアップ | [Lab 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
...
包括的な[学習ガイド](./study_guide.md)があり、このリポジトリを効果的に活用する方法を案内します。ガイドには以下が含まれます：
...
開発者がMCPを開発ワークフローで活用し、素晴らしいMCPコミュニティを祝うことを目的としています。Arcade、Block、Okta、NeonなどのコミュニティメンバーやパートナーがMicrosoftと協力してオープンで拡張可能なMCPエコシステムを形成する方法を紹介します。
- VS Code、Visual Studio、GitHub Copilot、人気のコミュニティツールを使用した実際のデモ
- 実践的でコンテキストに基づいた開発ワークフロー
- コミュニティ主導のセッションと洞察
MCPを始めたばかりの方も、すでに構築している方も、Day 1はインスピレーションと実践的な知識を提供します。

#### [Day 2: MCPサーバーを自信を持って構築する](https://developer.microsoft.com/en-us/reactor/series/S-1563/)

MCP構築者向けの内容です。MCPサーバーを作成し、AIワークフローに統合するための実装戦略とベストプラクティスを深く掘り下げます。
...
開発者、ツール構築者、AI製品戦略家にとって、スケーラブルで安全、そして将来に対応したMCPソリューションを構築するための洞察が詰まった内容です。

### MCPブートキャンプ 2025年8月
MCPサーバーを作成し、VS Codeと統合し、Azure上でプロフェッショナルにデプロイする方法を、MCP初心者向けカリキュラムの内容に基づいた集中的なビデオセッションで学びます。実践的なスキルを習得し、主要企業がすでに使用している技術を体験してください。
...
### MCPをC#で学ぼう - チュートリアルシリーズ
AIモデルとクライアントアプリケーション間のインタラクションを標準化するために設計された最先端のフレームワークであるModel Context Protocol (MCP)について学びましょう。この初心者向けセッションでは、MCPを紹介し、最初のMCPサーバーを作成する方法を案内します。
...
このプロジェクトは貢献と提案を歓迎します。ほとんどの貢献には、コントリビューターライセンス契約（CLA）に同意する必要があります。これにより、貢献者がその貢献を使用する権利を持ち、実際にその権利を提供することを宣言します。詳細については、<https://cla.opensource.microsoft.com>をご覧ください。

プルリクエストを送信すると、CLAボットが自動的にCLAを提供する必要があるかどうかを判断し、PRに適切な装飾（例：ステータスチェック、コメント）を行います。ボットの指示に従うだけで、CLAを提供する必要があるのはすべてのリポジトリで一度だけです。
...
- **11-MCPServerHandsOnLabs/**: PostgreSQL統合を備えた実運用対応のMCPサーバーを構築するための完全な13ラボ学習パス
