...
| 3.9 | Penyebaran | Sebarkan server MCP ke produksi | [Panduan](./03-GettingStarted/09-deployment/README.md) |
...
| 11 | Integrasi Database Server MCP | Jalur pembelajaran 13-lab yang komprehensif untuk integrasi PostgreSQL | [Labs](./11-MCPServerHandsOnLabs/README.md) |
...
Panduan Belajar [Study Guide](./study_guide.md) yang komprehensif tersedia untuk membantu Anda menavigasi repositori ini dengan efektif. Panduan ini mencakup:
...
Apakah Anda baru memulai dengan MCP atau sudah membangunnya, Hari 1 akan memberikan inspirasi dan langkah-langkah yang dapat diambil.
...
- **Kurikulum Inti (00-11)**: Konten utama yang diatur dalam sebelas modul berurutan, termasuk lab integrasi database yang komprehensif
...
- **translated_images/**: Versi diagram dan ilustrasi yang dilokalkan
...
Proyek ini mungkin mengandung merek dagang atau logo untuk proyek, produk, atau layanan. Penggunaan merek dagang atau logo Microsoft yang diizinkan harus sesuai dan mengikuti [Panduan Merek Dagang & Merek Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
